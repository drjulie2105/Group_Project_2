...
ALTER TABLE "Democrat_2000" ADD CONSTRAINT "fk_Democrat_2000_state" FOREIGN KEY("state")
REFERENCES "turnout_2000" ("State");
...
ALTER TABLE "Republican_2000" ADD CONSTRAINT "fk_Republican_2000_state" FOREIGN KEY("state")
...
ALTER TABLE "turnout_2008" ADD CONSTRAINT "fk_turnout_2008_State" FOREIGN KEY("State")
...
ALTER TABLE "turnout_2016" ADD CONSTRAINT "fk_turnout_2016_State" FOREIGN KEY("State")
REFERENCES "Democrat_2016" ("state");
